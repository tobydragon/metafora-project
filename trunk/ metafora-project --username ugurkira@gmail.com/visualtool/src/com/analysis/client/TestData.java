...
import com.analysis.client.datamodels.Country;
import com.analysis.client.datamodels.Folder;
import com.analysis.client.datamodels.MailItem;
import com.analysis.client.datamodels.Music;
import com.analysis.client.datamodels.Plant;
import com.analysis.client.datamodels.State;
import com.analysis.client.datamodels.Stock;
import com.analysis.client.datamodels.Task;
import com.analysis.client.datamodels.TeamSales;
...
public class TestData {
  ...
  public static List<Stock> getMonitorEvents() {
	    DateTimeFormat f = DateTimeFormat.getFormat("M/d h:mma");
	    List<Stock> stocks = new ArrayList<Stock>();
	    stocks.add(new Stock("Alex", 71.72, 0.02, 0.03, f.parse("4/2 12:00am"),
	        "SendingMessage"));
	    stocks.add(new Stock("David", 29.01, 0.42, 1.47, f.parse("4/1 12:00am"),
	        "SendingMessage"));
	    stocks.add(new Stock("Ugur", 83.81, 0.28, 0.34, f.parse("4/3 12:00am"),
	        "SendingMessage"));
	    stocks.add(new Stock("Oliver", 52.55, 0.01, 0.02,
	        f.parse("4/8 12:00am"), "SendingMessage"));
	    stocks.add(new Stock("Toby", 64.13, 0.31, 0.49,
	        f.parse("4/1 12:00am"), "SendingMessage"));
	    stocks.add(new Stock("Bruce", 31.61, -0.48, -1.54, f.parse("4/8 12:00am"),
	        "SendingMessage"));
	    stocks.add(new Stock("Nina", 75.43, 0.53, 0.71, f.parse("4/8 12:00am"),
	        "CreateLink"));
	    stocks.add(new Stock("Chris", 67.27, 0.92, 1.39, f.parse("4/1 12:00am"),
	        "CreateLink"));
	    stocks.add(new Stock("Jane", 49.37, 0.02, 0.04, f.parse("4/4 12:00am"),
	        "CreateLink"));
	    stocks.add(new Stock("Jacke", 40.48, 0.51, 1.28,
	        f.parse("4/1 12:00am"), "CreateLink"));
	    stocks.add(new Stock("Reiner", 68.1, -0.43, -0.64, f.parse("4/3 12:00am"),
	        "CreateLink"));
	    stocks.add(new Stock("Emre", 34.14, -0.08, -0.23,
	        f.parse("4/3 12:00am"), "CreateLink"));
	    stocks.add(new Stock("Benjamin", 30.27, 1.09, 3.74,
	        f.parse("4/3 12:00am"), "CreateLink"));
	    stocks.add(new Stock("Jens", 36.53, -0.03, -0.08,
	        f.parse("4/3 12:00am"), "CreateLink"));
	    stocks.add(new Stock("Ugur", 38.77, 0.05, 0.13, f.parse("4/3 12:00am"),
	        "CreateLink"));
	    stocks.add(new Stock("Ahmet", 19.88, 0.31, 1.58, f.parse("4/2 12:00am"),
	        "CreateLink"));
	    stocks.add(new Stock("Pelin", 81.41, 0.44, 0.54,
	        f.parse("4/1 12:00am"), "CreateLink"));
	    stocks.add(new Stock("Johnson", 64.72, 0.06, 0.09, f.parse("4/2 12:00am"),
	        "CreateLink"));
	    stocks.add(new Stock("Max", 45.73, 0.07, 0.15,
	        f.parse("4/2 12:00am"), "DeleteObject"));
	    stocks.add(new Stock("Aref", 36.76, 0.86, 2.40,
	        f.parse("4/2 12:00am"), "DeleteObject"));
	    stocks.add(new Stock("Katja", 40.96, 0.41, 1.01, f.parse("4/2 12:00am"),
	        "DeleteObject"));
	    stocks.add(new Stock("Bill", 25.84, 0.14, 0.54,
	        f.parse("4/2 12:00am"), "DeleteObject"));
	    stocks.add(new Stock("Philip", 27.96, 0.4, 1.45, f.parse("4/8 12:00am"),
	        "DeleteObject"));
	    stocks.add(new Stock("Kent", 45.07, 0.26, 0.58,
	        f.parse("4/1 12:00am"), "DeleteObject"));
	    stocks.add(new Stock("Heide", 34.64, 0.35, 1.02,
	        f.parse("4/8 12:00am"), "DeleteObject"));
	    stocks.add(new Stock("Philips", 61.91, 0.01, 0.02,
	        f.parse("4/1 12:00am"), "DeleteObject"));
	    stocks.add(new Stock("Toby", 63.26, 0.55, 0.88,
	        f.parse("4/1 12:00am"), "DeleteObject"));
	    stocks.add(new Stock("Ugur", 35.57, 0.39, 1.11,
	        f.parse("4/3 12:00am"), "DeleteObject"));
	 	    return stocks;
	  }
  ...
  public static List<Stock> getObjectEvents() {
	    DateTimeFormat f = DateTimeFormat.getFormat("M/d h:mma");
	    List<Stock> stocks = new ArrayList<Stock>();
	    stocks.add(new Stock("Alex", 71.72, 0.02, 0.03, f.parse("4/2 12:00am"),
	        "CreateObject"));
	    ...
	    stocks.add(new Stock("Ugur", 83.81, 0.28, 0.34, f.parse("4/3 12:00am"),
	        "CreateObject"));
	    stocks.add(new Stock("Oliver", 52.55, 0.01, 0.02,
	        f.parse("4/8 12:00am"), "CreateObject"));
	    stocks.add(new Stock("Toby", 64.13, 0.31, 0.49,
	        f.parse("4/1 12:00am"), "CreateObject"));
	    stocks.add(new Stock("Bruce", 31.61, -0.48, -1.54, f.parse("4/8 12:00am"),
	        "CreateObject"));
	    stocks.add(new Stock("Nina", 75.43, 0.53, 0.71, f.parse("4/8 12:00am"),
	        "UpdateObject"));
	    ...
	    stocks.add(new Stock("Jane", 49.37, 0.02, 0.04, f.parse("4/4 12:00am"),
	        "UpdateObject"));
	    stocks.add(new Stock("Jacke", 40.48, 0.51, 1.28,
	        f.parse("4/1 12:00am"), "UpdateObject"));
	    stocks.add(new Stock("Reiner", 68.1, -0.43, -0.64, f.parse("4/3 12:00am"),
	        "UpdateObject"));
	    stocks.add(new Stock("Emre", 34.14, -0.08, -0.23,
	        f.parse("4/3 12:00am"), "UpdateObject"));
	    stocks.add(new Stock("Benjamin", 30.27, 1.09, 3.74,
	        f.parse("4/3 12:00am"), "UpdateObject"));
	    stocks.add(new Stock("Jens", 36.53, -0.03, -0.08,
	        f.parse("4/3 12:00am"), "UpdateObject"));
  ...
  public static List<Stock> getUserEvents() {
	    DateTimeFormat f = DateTimeFormat.getFormat("M/d h:mma");
	    List<Stock> stocks = new ArrayList<Stock>();
	    stocks.add(new Stock("Alex", 71.72, 0.02, 0.03, f.parse("4/2 12:00am"),
	        "JoinSession"));
	    ...
	    stocks.add(new Stock("Ugur", 83.81, 0.28, 0.34, f.parse("4/3 12:00am"),
	        "JoinSession"));
	    stocks.add(new Stock("Oliver", 52.55, 0.01, 0.02,
	        f.parse("4/8 12:00am"), "JoinSession"));
	    stocks.add(new Stock("Toby", 64.13, 0.31, 0.49,
	        f.parse("4/1 12:00am"), "JoinSession"));
	    stocks.add(new Stock("Bruce", 31.61, -0.48, -1.54, f.parse("4/8 12:00am"),
	        "JoinSession"));
	    stocks.add(new Stock("Nina", 75.43, 0.53, 0.71, f.parse("4/8 12:00am"),
	        "JoinSession"));
	    ...
	    stocks.add(new Stock("Jane", 49.37, 0.02, 0.04, f.parse("4/4 12:00am"),
	        "Blocked"));
	    stocks.add(new Stock("Jacke", 40.48, 0.51, 1.28,
	        f.parse("4/1 12:00am"), "Blocked"));
	    stocks.add(new Stock("Reiner", 68.1, -0.43, -0.64, f.parse("4/3 12:00am"),
	        "Blocked"));
	    stocks.add(new Stock("Emre", 34.14, -0.08, -0.23,
	        f.parse("4/3 12:00am"), "Blocked"));
	    stocks.add(new Stock("Benjamin", 30.27, 1.09, 3.74,
	        f.parse("4/3 12:00am"), "Blocked"));
	    stocks.add(new Stock("Jens", 36.53, -0.03, -0.08,
	        f.parse("4/3 12:00am"), "Blocked"));
	    ...
	    stocks.add(new Stock("Johnson", 64.72, 0.06, 0.09, f.parse("4/2 12:00am"),
	        "Blocked"));
	    stocks.add(new Stock("Max", 45.73, 0.07, 0.15,
	        f.parse("4/2 12:00am"), "LeaveSession"));
	    stocks.add(new Stock("Aref", 36.76, 0.86, 2.40,
	        f.parse("4/2 12:00am"), "LeaveSession"));
	    stocks.add(new Stock("Katja", 40.96, 0.41, 1.01, f.parse("4/2 12:00am"),
	        "LeaveSession"));
	    ...
	    stocks.add(new Stock("Philip", 27.96, 0.4, 1.45, f.parse("4/8 12:00am"),
	        "LeaveSession"));
	    stocks.add(new Stock("Kent", 45.07, 0.26, 0.58,
	        f.parse("4/1 12:00am"), "LeaveSession"));
	    stocks.add(new Stock("Heide", 34.64, 0.35, 1.02,
	        f.parse("4/8 12:00am"), "LeaveSession"));
	    stocks.add(new Stock("Philips", 61.91, 0.01, 0.02,
	        f.parse("4/1 12:00am"), "LeaveSession"));
	    stocks.add(new Stock("Toby", 63.26, 0.55, 0.88,
	        f.parse("4/1 12:00am"), "LeaveSession"));
	    stocks.add(new Stock("Ugur", 35.57, 0.39, 1.11,
	        f.parse("4/3 12:00am"), "LeaveSession"));
	 	    return stocks;
	  }
