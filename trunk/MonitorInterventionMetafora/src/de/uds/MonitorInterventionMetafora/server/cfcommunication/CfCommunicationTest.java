...
//	
	public void testSimpleFileInput(){
		SimpleCfFileCommunicationBridge simpleBridge = new SimpleCfFileCommunicationBridge("war/conffiles/xml/test/analysisChannelOutput-PlaTo.xml", "war/conffiles/xml/test/analysisChannelOutput.xml");
