...
//		System.out.println(testDataRetreiver.getModel().getAllActions());
		ActionPropertyValueGroupingTableModel table = new ActionPropertyValueGroupingTableModel(new ActionPropertyRule(ActionElementType.ACTION_TYPE, "classification"));
