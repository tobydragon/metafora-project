...
import de.uds.MonitorInterventionMetafora.client.view.widgets.PopupIndicatorDisplay;
...
public class GridSelectionPopUpListener extends GridSelectionModel<IndicatorGridRowItem>{
	...
	public void handleEvent(BaseEvent e){
		...
		if (e instanceof GridEvent<?>){
			...
			final PopupIndicatorDisplay popup = new PopupIndicatorDisplay(indicator);
		}
